...
print ('Buyers: ', buyers)
print ('Prices: ', prices)
the_page =   "  <div class='ipsNavBar_primary ipsNavBar_noSubBars ipsClearfix topmenu'><nav class='ipsLayout_container ipsNavBar_primary ipsNavBar_noSubBars'><ul data-role='primaryNavBar' class='ipsResponsive_showDesktop ipsResponsive_block'><li id='elNavSecondary_145' data-role='navBarItem' data-navapp='core' data-navext='Menu' data-originalwidth='173'>href='#' id='elNavigation_145' data-ipsmenu='' data-ipsmenu-appendto='#elNavSecondary_145' data-ipsmenu-activeclass='ipsNavActive_menu' data-navitem-id='145'>ocStore <i class='fa fa-caret-down'></i></a><ul id='elNavigation_145_menu' class='ipsHide ipsMenu ipsMenu_auto'><li class='ipsMenu_item'><a href='https://ocstore.com' rel='nofollow noopener' target='_blank'>Официальный сайт</a></li><li class='ipsMenu_item'><a href='https://demo.ocstore.com' rel='nofollow noopener' target='_blank'>Демо</a></li>"
#htmlparser = etree.HTMLParser()
#tree = etree.parse(the_page, htmlparser)
#print(type(tree))
soup = BeautifulSoup(the_page,'html.parser')
#tree = html.fromstring(soup.content)
#print(soup)#.xpath('div'))
print(type(soup))
tag =  soup.get_text()
print(tag)
print(type(tag))
...
#   rules = (Rule(
#       LinkExtractor(
            #allow = r'*',#allow=r'zhenskaya_odezhda/dzhinsy/',
