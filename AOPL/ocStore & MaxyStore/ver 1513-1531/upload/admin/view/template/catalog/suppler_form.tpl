...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/shipping.png" alt="" /> <?php echo $heading_title; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $entry_formdate.' '.$supplers['formdate']; ?></h1>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="name" value="<?php echo $supplers['name']; ?>" maxlength="64" size="28" />
                <?php if ($error_name) { ?>
            ...
            <tr style=" background: #EEEEEE;">
              ...
              <td><input type="text" name="ratep" value="<?php echo $supplers['ratep']; ?>" maxlength="13" size="12" /></td><td></td><td></td>			  
			</tr>
            <tr>	
			  <td><span class="required">* </span> <?php echo $entry_cod; ?><br /><br />
			  <?php echo $entry_pars; ?><br /><br /><?php echo $entry_skuopt; ?></td>  
			  <td><input type="text" name="cod" value="<?php echo $supplers['cod']; ?>" maxlength="128" size="28" title = "e.g.  prod_code&gt;,&lt;/p"/>
			  <br/><br/><br/><br/><input type="text" name="parss" value="<?php if (isset($supplers['parss'])) echo $supplers['parss']; ?>" maxlength="4" size="4" />
			  <input type="hidden" name="jopt">
			  <br /><br /><?php if ($supplers['optsku'] == '0') { ?>
			  ...
			  <td width="200"><?php echo $entry_point1; ?><br/><br/><?php echo $entry_place; ?><br/><br /><?php echo $entry_prefix; ?></td>
			 <td><input type="text" name="points" value="<?php echo $supplers['points']; ?>" maxlength="64" size="28" title = "e.g. class=&quot;product_param&quot;&gt;"/><br /><br /><br /><input type="text" name="places" value="<?php if (isset($supplers['places'])) echo $supplers['places']; ?>" maxlength="4" size="4" title = "1 - by default"/><br /><br /><input type="text" name="skuprefix" value="<?php echo $supplers['skuprefix']; ?>" maxlength="24" size="8" /></td>			
			  <td width="200"><?php echo $entry_sku2; ?><br/><br/>
			  <?php echo $entry_stay; ?><br/><br/>
			  <?php echo $entry_joen; ?>
			  </td>  
			  <td><input type="text" name="sku2" value="<?php echo $supplers['sku2']; ?>" maxlength="3" size="2" /><br/><br/>
			...
			<tr style=" background: #EEEEEE;">
              ...
              <td><input type="text" name="item" value="<?php echo $supplers['item']; ?>" maxlength="128" size="28" title = "e.g. title&gt;,&lt;/tit"/>
			 ...
			 <td><input type="text" name="pointi" value="<?php echo $supplers['pointi']; ?>" maxlength="64" size="28" title = "e.g. head"/><br/><br/><br/><input type="text" name="placei" value="<?php if (isset($supplers['placei'])) echo $supplers['placei']; ?>" maxlength="4" size="4" title = "1 - by default" /></td>		
		     <td width="200">
			...
			<tr>
			  ...
			  <?php echo $entry_pars; ?></td>
              <td><input type="text" name="cat" value="<?php if (isset($supplers['cat'])) echo $supplers['cat']; ?>" maxlength="512" size="28" title = "e.g. 'category=,&" /><br/><br/><br/><input type="text" name="parsc" value="<?php echo $supplers['parsc']; ?>" maxlength="4" size="4"/></td>
			  <td width="200"><?php echo $entry_point1; ?><br/><br/><br/><?php echo $entry_place; ?></td>
			 <td><input type="text" name="pointc" value="<?php echo $supplers['pointc']; ?>" maxlength="64" size="28" title = "e.g. function slot_go(value)" /><br/><br/><br/><input type="text" name="placec" value="<?php if (isset($supplers['placec'])) echo $supplers['placec']; ?>" maxlength="4" size="4" title = "1 - by default" /></td>			
			<td width="200"><br /> 
			...
			<tr style=" background: #EEEEEE;">
			  <td>* </span><?php echo $entry_qu; ?><br/><br/><br/>
			  <?php echo $entry_pars; ?></td>
              <td><input type="text" name="qu" value="<?php echo $supplers['qu']; ?>" maxlength="128" size="28" /><br/><br/><br/><br/><input type="text" name="parsq" value="<?php echo $supplers['parsq']; ?>" maxlength="4" size="4"/></td>
			  <td width="200"><?php echo $entry_point1; ?><br/><br/><br/><?php echo $entry_place; ?></td>
			 <td><input type="text" name="pointq" value="<?php echo $supplers['pointq']; ?>" maxlength="64" size="28" title = "e.g. function slot_go(value)" /><br/><br/><br/><br/><input type="text" name="placeq" value="<?php if (isset($supplers['placeq'])) echo $supplers['placeq']; ?>" maxlength="4" size="4" title = "1 - by default" /></td>
			  <td width="200"><?php echo $entry_qu_discount; ?><br /><br/><?php echo $entry_minus; ?><br /><br/>
			  <?php echo $entry_myqu; ?>
			  <td>
				<input type="text" name="qu_discount" value="<?php echo $supplers['qu_discount']; ?>" maxlength="128" size="28" /><br/><br/>
                ...
                <?php echo $text_no; ?>
                <?php } ?><br/><br/>
				<input type="text" name="my_qu" value="<?php echo $supplers['my_qu']; ?>" maxlength="512" size="45" title = "e.g. 10-50=20,+=10,++=20,Нет=0,нет=0,Есть=5" />
				</td>			  
            </tr>			
			<tr>
              ...
              <td><input type="text" name="price" value="<?php if (isset($supplers['price'])) echo $supplers['price']; ?>" maxlength="128" size="28"  title = "e.g. &lt;/div&gt;&lt;div class=&quot;total-price&quot;&gt;,&lt;/" /><br/><br/><br/><input type="text" name="parsp" value="<?php echo $supplers['parsp']; ?>" maxlength="4" size="4"/><br/><br/><br/>
				<input type="text" name="rprice" value="<?php echo $supplers['rprice']; ?>" maxlength="4" size="12"/> <br/><br/><br/>
			  <input type="text" name="usd" value="<?php echo $supplers['usd']; ?>" maxlength="4" size="4"/>
			  </td>
			  <td width="200"><?php echo $entry_point1; ?><br/><br/><br/><br/><?php echo $entry_placep; ?>
			  <br/><br/><br /><?php echo $entry_myprice;?><br/></td>
			 <td><input type="text" name="pointp" value="<?php echo $supplers['pointp']; ?>" maxlength="64" size="28" title = "e.g. function slot_go(value)" /><br/><br/><br/><br/>
			 <select name="placep">
			...
			<tr style=" background: #EEEEEE;">
			  ...
			  <?php echo $entry_pars; ?></td>
              <td><input type="text" name="descrip" value="<?php if (isset($supplers['descrip'])) echo $supplers['descrip']; ?>" maxlength="128" size="28" title = "e.g. &lt;div&gt;,&lt;/div&gt;,&lt;/div&gt;" /><br /><br/><br/><input type="text" name="parsd" value="<?php echo $supplers['parsd']; ?>" maxlength="4" size="4"/></td>
			  <td width="200"><?php echo $entry_point1; ?><br /><br /><?php echo $entry_place; ?></td>
			  <td><input type="text" name="pointd" value="<?php echo $supplers['pointd']; ?>" maxlength="64" size="28" title = "e.g. &lt;div class=&quot;full-desc&quot;&gt;" /><br/><br/><br /><input type="text" name="placed" value="<?php if (isset($supplers['placed'])) echo $supplers['placed']; ?>" maxlength="4" size="4" title = "1 - by default"/></td>			  
			  <td width="200"><?php echo $entry_mydescrip; ?><br/><br/>
			  <?php echo $entry_updte; ?><br/><br/>
			  <?php echo $entry_ddesc; ?></td>
			  
			  <td><input type="text" name="my_descrip" value="<?php echo $supplers['my_descrip']; ?>" maxlength="512" size="45"  title = "e.g. Подробности смотрите в разделе Характеристики"/>
			  <br/><br/>
				<select name="updte">
			...
			<tr>
			  ...
			  <?php echo $entry_pars; ?></td>
              <td><input type="text" name="manuf" value="<?php if (isset($supplers['manuf'])) echo $supplers['manuf']; ?>" maxlength="128" size="28" title = "e.g. + 'BREND: ,("/><br /><br/><br/><input type="text" name="parsm" value="<?php echo $supplers['parsm']; ?>" maxlength="4" size="4"/></td>
			  <td width="200"><?php echo $entry_point1; ?><br/><br/><br/><?php echo $entry_place; ?></td>
			  <td><input type="text" name="pointm" value="<?php echo $supplers['pointm']; ?>" maxlength="64" size="28" title = "e.g. &lt;script&gt; " /><br/><br/><br/><input type="text" name="placem" value="<?php if (isset($supplers['placem'])) echo $supplers['placem']; ?>" maxlength="4" size="4" title = "1 - by default" /></td>			  
			...
			<tr style=" background: #EEEEEE;">
			  <td>* </span><?php echo $entry_pic_ext; ?><br/><br/>
			  <?php echo $entry_pars; ?></td>
              <td><input type="text" name="pic_ext" value="<?php if (isset($supplers['pic_ext'])) echo $supplers['pic_ext']; ?>" maxlength="1024" size="28" title = "e.g. 12,13,18,14" /><br /><br/><br/><input type="text" name="parsk" value="<?php echo $supplers['parsk']; ?>" maxlength="4" size="4"/></td>
			  <td width="200"><?php echo $entry_mymark; ?><br /><br /><br /><?php echo $entry_warranty; ?></td>
			  <td><input type="text" name="my_mark" value="<?php if (isset($supplers['my_mark'])) echo $supplers['my_mark']; ?>" maxlength="1024" size="28" title = "e.g. big-photo,alt=,alt=,alt=,alt" /><br  /><br /><br /><input type="text" name="warranty" value="<?php echo $supplers['warranty']; ?>" maxlength="1024" size="28" title = "e.g. &lt;1,&gt;3,&gt;4,&gt;5,&gt;6"/></td>
				  
			  <td width="200"><?php echo $entry_myphoto; ?><br /><br /><?php echo $entry_newphoto; ?><br /><br /><?php echo $entry_subfolder; ?></td>
			  <td>
			  <input type="text" name="my_photo" value="<?php echo $supplers['my_photo']; ?>" maxlength="512" size="45" title = "e.g. http//:www.bla-bla-bla.com/pic-gallery/12345.jpg"/>	
				<br /><br />
			...
			<tr>
			  ...
			  <td><input type="text" name="t_status" value="<?php echo $supplers['t_status']; ?>" maxlength="255" size="28" /></td>
			...
			<tr style=" background: #EEEEEE;">
              ...
              <td>UPC:<input type="text" name="upc" value="<?php if (isset($supplers['upc'])) echo $supplers['upc']; ?>" size="1" />
                ...
                MPN:<input type="text" name="mpn" value="<?php if (isset($supplers['mpn'])) echo $supplers['mpn']; ?>" size="1" /></td>
			...
			<tr>
              ...
              <td><input type="text" name="bonus" value="<?php if (isset($supplers['bonus'])) echo $supplers['bonus']; ?>" maxlength="128" size="28" /></td>	
			  <td width="200" style=" background: #E5E2D9;" /><br /><br /> <?php echo $entry_addseo; ?><br /><br />
			...
			<tr>
              ...
              <td>M:<input type="text" name="weight" value="<?php echo $supplers['weight']; ?>" size="1" />
				L:<input type="text" name="length" value="<?php echo $supplers['length']; ?>" size="1" />
                W:<input type="text" name="width" value="<?php echo $supplers['width']; ?>" size="1" />
                H:<input type="text" name="height" value="<?php echo $supplers['height']; ?>" size="1" />
				</td>			  		
			...
			<tr>
			  ...
			  <td width="200" style=" background: #D8D4C8;" /><?php echo $entry_upopt; ?></td>
              <td style=" background: #D8D4C8;" />			  
			  <?php if ($supplers['upopt']) { ?>
                <input type="radio" name="upopt" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="upopt" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="upopt" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="upopt" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?> 
			  </td>
				</td>
			  <td width="200" style=" background: #D8D4C8;" /><?php echo $entry_addopt; ?></td>
			...
			<tr>
			  ...
			  <td width="200" style=" background: #D8D4C8;" /><?php echo $entry_opt_fotos; ?>
              <td style=" background: #D8D4C8;" />
			...
			<tr>
              ...
              <td><input type="text" name="spec" value="<?php if (isset($supplers['spec'])) echo $supplers['spec']; ?>" maxlength="128" size="28" /></td>
			...
			<input type="text" name="delimiter" value="<?php echo $supplers['delimiter']; ?>" maxlength="20" size="10" /></td>
              <td><select name="ad">
		...
		<div id="tab-attribute">
          <table class="form">
			...
			<tr>
              ...
              <td><input type="text" name="attr_ext[]" value="" maxlength="128" size="25" title = "e.g. &lt;div class=&quot;param&quot;&gt;,&lt;/div&gt;,&lt;td&gt;,&lt;/td&gt;" /></td>
			  <td width="150"><?php echo $entry_point1; ?></td>
			  <td><input type="text" name="attr_point[]" value="" maxlength="64" size="25" title = "e.g. &lt;div class=&quot;attribute-block" /></td>
			...
			<tr>	
			  <td width="150"><?php echo $entry_filter; ?></td>
			...
			<tr style=" background: #EEEEEE;" />
			  <td><?php echo $entry_attrib; ?></td>
              <td><input type="text" name="attr_ext[]" value="" maxlength="128" size="25" title = "e.g. &lt;div class=&quot;param&quot;&gt;,&lt;/div&gt;,&lt;td&gt;,&lt;/t" /></td>
			  <td width="150"><?php echo $entry_point1; ?></td>
			  <td><input type="text" name="attr_point[]" value="" maxlength="128" size="25" title = "e.g. &lt;div class=&quot;attribute-block" /></td>
			  <td width="150"><?php echo $entry_attribute; ?></td>
              <td><select name="attribute_id[]">
                  <option value="0"><?php echo $text_left; ?></option>
                  <?php foreach ($attributes as $attribute) { ?>
			...
			<tr>
			  <td><?php echo $entry_attrib; ?></td>
              <td><input type="text" name="attr_ext[]" value="" maxlength="128" size="25" title = "e.g. 'attrib=,','" /></td>
			  <td width="150"><?php echo $entry_point1; ?></td>
			  <td><input type="text" name="attr_point[]" value="" maxlength="64" size="25" title = "e.g. &lt;div class=&quot;attribute-block" /></td>
			  <td width="150"><?php echo $entry_attribute; ?></td>
              <td><select name="attribute_id[]">
			...
			<tr>	
             ...
             <?php foreach ($sa as $sa) { $i=$i+1; $j = $j +1; if (pow ($a,$i) < 1) echo '<tr style=" background: #EEEEEE;" />';
			  ...
			  <td><?php echo $entry_attrib; ?></td>
         	  <td><input type="text" name="attr_ext[]" value="<?php echo $sa['attr_ext']; ?>" maxlength="128" size="25"/></td>
			  <td width="150"><?php echo $entry_point1; ?></td>
			  <td><input type="text" name="attr_point[]" value="<?php echo $sa['attr_point']; ?>" maxlength="64" size="25" /></td>
			  <td width="150"><?php echo $entry_attribute; ?></td>			  
              <td><select name="attribute_id[]">
                  <option value="0"><?php echo $text_left; ?></option>
                  <?php foreach ($attributes as $attribute) { ?>
		...
		<div id="tab-option">
          <table class="form">
            <tbody>
			<tr>
			  <td style="width: 140px;"><?php echo $entry_option; ?></td>
              <td><select name="option_id[]">
				...
				<td><input type="text" name="art[]" value="" maxlength="4" size="4" /></td>
				...
				<tr>
				<td style="width: 140px;"></span><?php echo $entry_pr; ?></td>
				...
				<td><input type="text" name="foto[]" value="" maxlength="4" size="4" /></td>
             ...
             <?php foreach ($op as $op) { $i=$i+1; $j = $j +1; if (pow ($a,$i) < 1) echo '<tr style=" background: #EEEEEE;" />';
              ...
              <td><select name="option_id[]">
				...
				<td><?php echo $entry_art; ?></td>				
				<td><input type="text" name="art[]" value="<?php echo $op['art']; ?>" maxlength="4" size="4" /></td>
				<td><span class="required">*</span><?php echo $entry_ko; ?></td>				
				...
				<td><?php echo $entry_foto; ?></td>
				<td><input type="text" name="foto[]" value="<?php echo $op['foto']; ?>" maxlength="4" size="4" /></td>
				<td><?php echo $entry_plusopt; ?></td>
				<td>
				 <select name="opt_margin[]">			      		
          ...
          <table class="form">
			...
			<tr>
              <td><?php echo $entry_noprice; ?></td>
				...
				<td><?php echo $entry_site_param; ?></td>
				<td><input type="text" name="paramnp[]" maxlength="128" size="20" /></td>
				<td><?php echo $entry_point1; ?></td>
			...
			<?php if (pow ($a,$i) < 1) echo '<tr style=" background: #EEEEEE;" />';
				...
				<td><?php echo $entry_site_param; ?></td>
				<td><input type="text" name="paramnp[]" value="<?php echo $site['paramnp']; ?>" maxlength="128" size="20" /></td>
				<td><?php echo $entry_point1; ?></td>
		...
		<div id="tab-action">		
          <table class="form">
			...
			<tr style=" background: #EEEEEE;" />
              ...
              <td><div class="scrollbox" style="background: #EEEEEE;">                  
                  <?php foreach ($categories as $category) { ?>                  
			  ...
			  <td><strong><?php echo $entry_actmanuf; ?></strong><br /></td>
			  <td><div class="scrollbox" style="background: #EEEEEE;">                  
                  <?php foreach ($manufacturers as $manufacturer) { ?>                  
                    <div class="<?php if (isset($class)) echo $class; ?>">
		  ...
		  <tr style=" background: #EEEEEE;" />            
              ...
              <td><input type="text" name="act_sname" maxlength="2048" size="42" /> <?php echo $entry_any; ?> </td>
			 <td><strong><?php echo $entry_sdesc; ?></strong></td>
              <td><input type="text" name="act_sdesc" maxlength="2048" size="42" /> <?php echo $entry_any; ?> </td>
		  </tr>
		  <tr style=" background: #EEEEEE;" />            
			  <td><strong><?php echo $entry_attribut; ?></strong></td>
              <td><input type="text" name="act_attribut" maxlength="2048" size="42" /> <?php echo $entry_any; ?> </td>
			 <td><strong><?php echo $entry_noattribut; ?></strong></td>
              <td><input type="text" name="act_noattribut" maxlength="2048" size="42" /> <?php echo $entry_any; ?> </td>
		  </tr>
		  <tr style=" background: #EEEEEE;" />            
			 ...
			 <td><strong><?php echo $entry_isvalue; ?></strong></td>
              <td><input type="text" name="act_isvalue" maxlength="2048" size="42" /></td>
		  </tr>
		  <tr style=" background: #EEEEEE;" />            
		  ...
		  <tr>
			 ...
			 <td>
			  ...
			  <td><strong><?php echo $entry_find; ?></strong><br />
                <input type="text" name="act_find" maxlength="2048" size="28" /></td>			  
			  <td><strong><?php echo $entry_change; ?></strong>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  <strong><?php echo $entry_actfilter; ?></strong><br />			    
                <input type="text" name="act_change" maxlength="2048" size="28" /> 			    
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
