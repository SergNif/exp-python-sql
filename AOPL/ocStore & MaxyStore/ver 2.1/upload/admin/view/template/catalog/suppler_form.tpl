		...
		<table class="table table-hover">
		 ...
		 <tbody>
		  <tr>	
		   ...
		   <td style="width:250px;"><?php echo $entry_point1; ?><br/><br/><br /><?php echo $entry_place; ?><br/><br /><br /><?php echo $entry_prefix; ?></td>
		   <td><input type="text" name="points" value="<?php echo $supplers['points']; ?>" maxlength="64" size="18" title = "e.g. class=&quot;product_param&quot;&gt;"/><br /><br /><br /><br /><input type="text" name="places" value="<?php if (isset($supplers['places'])) echo $supplers['places']; ?>" maxlength="4" size="4" title = "1 - by default"/><br /><br /><br /><input type="text" name="skuprefix" value="<?php echo $supplers['skuprefix']; ?>" maxlength="24" size="8" /></td>
		  ...
		  <tr>
		   <tr style=" background: #EEEEEE;">
			...
			<tbody>
			  <tr>
			    <td>* <?php echo $entry_cat; ?><br/><br/>
			     <?php echo $entry_pars; ?></td>
                 <td><input type="text" name="cat" value="<?php if (isset($supplers['cat'])) echo $supplers['cat']; ?>" maxlength="512" size="18" title = "e.g. 'category=,&" /><br/><br/><br/><input type="text" name="parsc" value="<?php echo $supplers['parsc']; ?>" maxlength="4" size="4"/></td>
			...
			<tbody>
			  ...
			  <?php echo $entry_pars; ?></td>
              <td><input type="text" name="pic_ext" value="<?php if (isset($supplers['pic_ext'])) echo $supplers['pic_ext']; ?>" maxlength="1024" size="18" title = "e.g. 12,13,18,14" /><br /><br/><br/><input type="text" name="parsk" value="<?php echo $supplers['parsk']; ?>" maxlength="4" size="4"/></td>
			  <td width="250"><?php echo $entry_mymark; ?><br /><br /><br /><?php echo $entry_warranty; ?></td>
			  <td><input type="text" name="my_mark" value="<?php if (isset($supplers['my_mark'])) echo $supplers['my_mark']; ?>" maxlength="1024" size="18" title = "e.g. big-photo,alt=,alt=,alt=,alt" /><br  /><br /><br /><input type="text" name="warranty" value="<?php echo $supplers['warranty']; ?>" maxlength="1024" size="18" title = "e.g. &lt;1,&gt;3,&gt;4,&gt;5,&gt;6"/></td>
