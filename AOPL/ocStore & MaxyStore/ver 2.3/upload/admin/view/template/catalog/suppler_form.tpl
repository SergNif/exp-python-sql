		   ...
		   <tr style=" background: #EEEEEE;">
			...
			<tbody>
			 <tr>
              ...
              <td><input type="text" name="price" value="<?php if (isset($supplers['price'])) echo $supplers['price']; ?>" maxlength="128" size="18"  title = "e.g. &lt;/div&gt;&lt;div class=&quot;total-price&quot;&gt;,&lt;/" /><br/><br/><br/><br/><br /><input type="text" name="parsp" value="<?php echo $supplers['parsp']; ?>" maxlength="4" size="4"/><br/><br/><br /><br/>
				<input type="text" name="rprice" value="<?php echo $supplers['rprice']; ?>" maxlength="4" size="4"/> <br/><br/><br/><br /><br />
