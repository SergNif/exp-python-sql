...
class ControllerCatalogSuppler extends Controller { 
	...
	public function getBaseForm() {
		...
		$data['start'] = $this->url->link('catalog/suppler/start', 'token=' . $this->session->data['token']. '&form_id=' . $this->request->get['form_id'], 'SSL');
	...
	$data['delete'] = $this->url->link('catalog/suppler/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');	
  	...
  	private function getForm() {
		...
		if (isset($this->request->get['form_id'])) {
			$data['base'] = $this->url->link('catalog/suppler/base', 'token=' . $this->session->data['token']. '&form_id=' . $this->request->get['form_id'] . $url, 'SSL');
		} else {
